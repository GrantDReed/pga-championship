...
const PRICE_TIERS = {
  ...
  3: ["Ludvig Aberg", "Bryson DeChambeau", "Tommy Fleetwood", "Collin Morikawa", "Justin Rose", "Russell Henley", "Tyrrell Hatton", "Hideki Matsuyama", "Justin Thomas", "Sam Burns", "Brooks Koepka", "Robert MacIntyre", "Viktor Hovland", "Si Woo Kim", "Jacob Bridgeman"],
  2: ["Patrick Cantlay", "Akshay Bhatia", "Sungjae Im", "Jordan Spieth", "Maverick McNealy", "Shane Lowry", "Chris Gotterup", "Sepp Straka", "Min Woo Lee", "Jake Knapp", "Joaquin Niemann", "Thomas Detry", "Nicolai Hojgaard", "Sahith Theegala", "Harris English", "Daniel Berger", "J.J. Spaun", "Patrick Reed", "Adam Scott", "Keegan Bradley", "Jason Day", "J.T. Poston", "Corey Conners", "Gary Woodland", "Cameron Smith", "Kurt Kitayama", "Ryan Fox", "Rickie Fowler", "Alex Fitzpatrick", "Kristoffer Reitan", "Brandt Snedeker", "Matt McCarty", "Ben Griffin", "Michael Thorbjornsen", "Brian Harman", "Aaron Rai", "Ryan Gerard", "Nick Taylor", "Wyndham Clark", "Taylor Pendrith", "David Puig", "Marco Penge", "Alex Smalley", "Daniel Hillier", "Ryo Hisatsune"],
  1: ["Stewart Cink", "Tom McKibbin", "Brian Campbell", "Davis Riley", "Kazuki Higa", "Kota Kaneko", "Jordan Gumberg", "Andy Sullivan", "Adam Schenk", "Travis Smyth", "Joe Highsmith", "Elvis Smylie", "Bernd Wiesberger", "Adrien Saddier", "Sami Valimaki", "Jhonattan Vegas", "Emiliano Grillo", "Mikael Lindberg", "Andrew Putnam", "Daniel Brown", "Matti Schmid", "Aldrich Potgieter", "David Lipsky", "Chandler Blanchet", "Johnny Keefer", "Garrick Higgo", "Nico Echavarria", "Ian Holt", "Casey Jarvis", "William Mouw", "Ricky Castillo", "Austin Smotherman", "Patrick Rodgers", "Andrew Novak", "Max Greyserman", "Max McGreevy", "Billy Horschel", "Chris Kirk", "Steven Fisk", "John Parry", "Stephan Jaeger", "Christiaan Bezuidenhout", "Rasmus Neergaard-Petersen", "Rasmus Hojgaard", "Sudarshan Yellamaraju", "Rico Hoey", "Jayden Schaper", "Haotong Li", "Matt Wallace", "Denny McCarthy", "Angel Ayora", "Michael Kim", "Max Homa", "Pierceson Coody", "Bud Cauley", "Lucas Glover", "Dustin Johnson", "Michael Brennan", "Keith Mitchell", "Harry Hall", "Alex Noren", "Jordan Smith", "Sam Stevens", "Padraig Harrington", "Luke Donald", "Jimmy Walker", "Jason Dufner", "Shaun Micheel", "Y.E. Yang", "Martin Kaymer", "Jesse Droemer", "Michael Block", "Michael Katrude", "Jared Jones", "Ryan Lenahan", "Ben Polland", "Garrett Sapp", "Ryan Vermeer", "Mark Geddes", "Timothy Wiseman", "Austin Hurt", "Paul McClure", "Derek Berg", "Bryce Fisher", "Chris Gabriele", "Francisco Bide", "Ben Kern", "Zach Haynes", "Tyler Collet", "Braden Shattuck"],
};
